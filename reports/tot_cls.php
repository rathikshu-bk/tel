...
<section>
  <div class="container">
    <form action="post" actio="tot_cls.php">
    <table class="table">
          ...
          $sql = "SELECT `college_name` FROM clg_master ";     
                      ...
                      while($fetch = $result->fetch_assoc()){
                        ...
                        // $college_name1 =($_POST['clg_name']);
                         ...
                         $query_call_stauts = "SELECT count(*) FROM `$clg_name1` WHERE call_status1='1' ";
                         ...
                         $sum+=$pending_calls;
                         echo $sum;
                         $href = "tot_cls.php?clg_name=".$clg_name;
                         if($pending_calls>0){?>
                           <tr>
                            <td><?php echo $slno; ?></td>
                              </td><td name="clg_name"><a href ="<?php echo $href; ?>"><?php echo $clg_name; ?></a></td>
                              <td class="combat" ><?php echo $pending_calls; ?></td>
