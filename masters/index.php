<?php
session_start();
if(isset($_SESSION['user'])&&isset($_SESSION['user_priority'])&&($_SESSION['user_priority']<3)){
...
<div class="row">
    <div class="container main_container">
    <a href="user_master.php"><div class="col-lg-4"><div class="jumbotron sub_jumbo"><h3 class="h3"><span class="glyphicon glyphicon-user"></span> User Master</h3></div></div></a>

    <a href="clg.php"><div class="col-lg-4"><div class="jumbotron sub_jumbo"><h3 class="h3"><span class="glyphicon glyphicon-education"></span> College Master</h3></div></div></a>
    <a href="import.php"><div class="col-lg-4"><div class="jumbotron sub_jumbo"><h3 class="h3"><span class="glyphicon glyphicon-floppy-save"></span> DB Master</h3></div></div></a>
