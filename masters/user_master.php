...
<section>
	<div class="container">
		...
		<tr><th>Sl.No.</th><!-- <th>User Id</th> --><th>User Name</th><th>Action</th></tr>
					...
					?>
		<tr><td><?php echo $slno; ?></td><!-- <td><?php echo $user_id; ?> --></td><td><?php echo $user_name; ?></td><td><span class="btn btn-danger"><a style="text-decoration: none; color: #FFF;" href="<?php echo $href; ?>">Delete</a></span></td></tr>
