...
if(isset($_POST['submit'])){
 ...
 //echo $t1;
   ...
   //echo $check_ph;
        ...
        //$check_ph = $t1[$i];
        $s = "UPDATE $table_name SET `current_status`='Walkin' WHERE id='".$value."' ";

                $res=$conn->query($s);
                if($res){
                    echo '<div class="text-center h7 alert-success">Insert Success</div>';
                }else{
...
<ol class="breadcrumb">
  ...
  <li class="active">Walkin</li>
</ol>

</main>
</main>
<section>
  <form action="walkin_progress.php" method="post">
	<div class="container">
...
if(isset($_GET['clg_name'])){
  ...
  $clg_name=str_replace(' ', '_', $clg1_name);
    $_SESSION['walkin_progress']=$clg_name; 
  }
  if(isset($_SESSION['walkin_progress'])){
 $walkin=$_SESSION['walkin_progress'];
...
?>
                                ...
                                <td><?php echo $yop; ?></td>
                                  ...
                                  <td><input type="checkbox"<?php echo ($row['current_status']=='Walkin' ? 'checked' : '');?> class="form-check-input" id="walkin[]" name="walkin[]" value="<?php echo $id; ?>" ></td>
