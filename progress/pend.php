...
<main>
  ...
  <li><a href="index.php">Tel-C Progress</a></li>
...
<section>
	<form action="pending_pgs_dup.php" method="post" name="select_form">
	<div class="container">
		<table class="table">
		<tr><th>Sl.No.</th><!-- <th>User Id</th> --><th>College Name</th><th>Course</th><th>Pending Calls</th></tr>
					<?php
